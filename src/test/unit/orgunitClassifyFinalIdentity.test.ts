...
describe('computeFinalInputSha256', () => {
  ...
  it('the real v6 prompt version hashes differently from the explicit v1 comparator (2D2B-3, 2D2C-V3, 2D2C-V4I1, 2D2C-F0N/V5I1 and 2D2C-F1/V6I1 bumps)', () => {
    ...
    // reused as though it answered the prompt-v6 question.
