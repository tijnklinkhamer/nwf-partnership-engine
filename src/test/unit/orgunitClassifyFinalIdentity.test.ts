...
describe('computeFinalInputSha256', () => {
  ...
  it('the real v4 prompt version hashes differently from the explicit v1 comparator (2D2B-3, 2D2C-V3 and 2D2C-V4I1 bumps)', () => {
    ...
    // reused as though it answered the prompt-v4 question.
