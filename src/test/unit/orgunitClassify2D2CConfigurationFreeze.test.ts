...
import { v2FromV3, v3FromV4 } from '../harness/phase2b2d2c/promptLineage.js';
import {
...
describe('2D2C-F0 freeze: classifier configuration against production exports', () => {
  ...
  it('the frozen v2 identity is reconstructible from the current production prompt (v4) without Git', () => {
    // 2D2C-V4I1: production is now v4 (v3 + D1/D2/D3); the freeze still
    // names v2 and v1, both reconstructed by reversing the exact reviewed
    // deltas in sequence: v4 -> v3 -> v2 -> v1.
  ...
  it('removing the five reviewed insertions from v2 reproduces the frozen v1 identity without Git', () => {
    let stripped = v2FromV3(v3FromV4(ORGUNIT_CLASSIFIER_SYSTEM_PROMPT));
